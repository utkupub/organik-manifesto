...
### 01 - Manifesto Organika

- Eski puan: 5/10
- Yeni puan: 9/10
- Değişim: +4, yükseldi.
- Durum:
- Eski yorum: Kapak/metaveri etkisi ağırdı; görsel artefakt ve kapanmayan alıntı riski vardı.
- Not: Bu dosya kitap içi edebi bölüm değil, kitabın ilk sayfası/manifesto kartı olarak değerlendirilmeli; kısa ve kapak benzeri oluşu bu yüzden sorun sayılmaz.
- Güncel yorum: Slogan buraya taşınınca ilk sayfa işlevi tamamlandı; artık ad, özgürlük tarifi, ÇÖP fikri ve imza aynı sade kartta birleşiyor.
- Güçlü taraf: ÇÖP adını, özgürlük tarifini ve kitabın dönüşüm sloganını kısa ve akılda kalıcı biçimde kuruyor.
- Sorun: Belirgin metinsel sorun kalmadı; yalnız sayfa tasarımında boşluk ve yerleşim dikkat ister.
- Yapılacak: Yayın öncesi başlık, alt başlık, slogan, imza ve yıl yerleşimi görsel olarak kesinleştirilmeli.
...
- Değişim: +1, yükseldi.
- Durum:
- Eski yorum: Hak sırası iyi akıyordu; finalde `Mutluluk` doğru yerdeydi.
- Güncel yorum: Genel sıra hâlâ iyi; başlık uyumsuzluğu temizlendi.
- Güçlü taraf: Kitabın yolunu okura açık gösteriyor.
- Sorun: Teknik liste olduğu için edebi bölüm etkisi yok; yalnız son dosya sırası değişirse tekrar kontrol ister.
- Yapılacak: Yayın öncesi bölüm başlıkları, numaralar ve dosya sırası bir kez daha karşılaştırılmalı.
...
- Değişim: +1, yükseldi.
- Durum:
- Eski yorum: Okurla doğrudan ve samimi bağ kuruyordu.
- Güncel yorum: Slogan 01'e taşınınca bölüm daha kişisel ve güçlü kapanıyor; yeni bisiklet, sıska tekir ve palamut imgeleri sıcak ve duygusal tonu artırdı.
- Güçlü taraf: Okuru metne buyurgan değil, mahcup ve içten bir yerden çağırıyor; küçük eylemler artık daha somut ve canlı.
- Sorun: Belirgin sorun kalmadı; bölüm artık kısa, sıcak ve işlevsel bir eşik.
- Yapılacak: Korunmalı; son okumada yalnız küçük noktalama ve sayfa geçişi kontrol edilmeli.
...
- Durum:
- Eski yorum: Kitabın şiirsel çekirdeğiydi; memleket, doğa, aşk ve hareket duygusu çok iyi akıyordu.
- Güncel yorum: Hâlâ kitabın en güçlü açılış parçalarından.
- Güçlü taraf: Politik taraflaşmadan doğa, emek ve memleket sevgisine geçiş çok temiz.
- Sorun: Fazla kurcalanırsa yoğunluğu bozulabilir.
- Yapılacak: Korunmalı; yalnızca son biçim ve noktalama kontrolü yapılmalı.
...
- Değişim: +4, yükseldi.
- Durum:
- Eski yorum: Çok ince ve geçiş notu gibi kalıyordu.
- Not: Bu dosya bağımsız bölüm değil; `06 - Bir`, `07 - Hayal`, `08 - Hak`, `09 - Umut` dizisinin giriş kapısı olarak değerlendirilmelidir.
- Güncel yorum: Bağlam içinde kısa, temiz ve işlevsel bir ara eşik; dört temel kavramın sırasını okura bildiriyor.
- Güçlü taraf: `Bir`, `Hayal`, `Hak`, `Umut` dizisini tek nefeste ve gereksiz açıklama yapmadan bağlıyor.
- Sorun: Tek başına okunursa zayıf görünür; sayfa tasarımında ara kapı/girizgâh olduğu belli edilmeli.
- Yapılacak: Metin korunmalı; yayın düzeninde 06-09 alt dizisinin üst başlığı veya ara sayfası gibi konumlandırılmalı.
...
- Değişim: +1, yükseldi.
- Durum:
- Eski yorum: Kozmik birlik, kut ve yaşam duygusu kitabın temelini kuruyordu.
- Güncel yorum: Yeni toprak, su, hava ve küçük canlı ayrıntıları bölümün duygusal yükünü artırdı; kozmik birlik artık daha bedensel ve duyusal hissediliyor.
- Güçlü taraf: Gök, su, toprak, kalp, kut ve mikroskobik canlılardan yıldızlara uzanan ölçek çok güçlü; `Bu obur, koca yaşlı dünya` gibi şarkı sözü göndermeleri bilinçli kültürel katman olarak çalışıyor.
- Sorun: Belirgin sorun kalmadı; yalnız birkaç uzun imge satırı son okumada ritim açısından kontrol ister.
- Yapılacak: Korunmalı; son okumada yalnız ritim ve büyük/küçük harf birliği kontrol edilmeli.
...
- Değişim: +2, yükseldi.
- Durum:
- Eski yorum: Uzaydan dünyaya bakış, mandalina kokusu ve gece masalı hattı güzeldi.
- Güncel yorum: Açılış daha doğrudan ve duygusal; buğulu atmosfer, meşe rüyası, çay, mandalina ve gece masalı hattı artık daha iyi bağlanıyor.
- Güçlü taraf: Kozmik bakışı gözyaşı, çay, mandalina kokusu ve rüya imgeleriyle kişisel ve duyusal bir yere indiriyor.
- Sorun: Belirgin sorun kalmadı; bölüm artık kısa, şiirsel ve işlevsel.
- Yapılacak: Korunmalı; son okumada yalnız küçük harf/noktalama ve nefes yerleri kontrol edilmeli.
...
- Değişim: 0, aynı kaldı.
- Durum:
- Eski yorum: Kurbağalarla açılan sahne kitabın vicdani damarını net kuruyordu.
- Güncel yorum: Hâlâ en sarsıcı ve akılda kalıcı bölümlerden.
- Güçlü taraf: Kurbağa sahnesi, hak fikrini soyutluktan çıkarıp bedene indiriyor.
- Sorun: Suçlama zinciri uzun ama bölümün omurgası olduğu için şimdilik çalışıyor.
- Yapılacak: Fazla dokunulmamalı; yalnızca son noktalama ve alıntı biçimi kontrol edilmeli.
...
- Değişim: +1, yükseldi.
- Durum:
- Eski yorum: Tüketim, ekran, çocuk ve umut gerilimi iyi kurulmuştu.
- Güncel yorum: Hansel ve Gretel kırıntı/cadı hattı, dijital tüketim sepeti ve Orhan Veli'nin `Kargalar` şiirine göz kırpan `harbiye ve nezarethane` göndermesi birlikte çalışıyor.
- Güçlü taraf: Masal, çocukluk şekeri, internet sepeti, kargalar ve Orhan Veli çağrışımı aynı tüketim/umut gerilimine bağlanıyor.
- Sorun: Belirgin sorun kalmadı; göndermeler bilerek katmanlı kurulmuş.
- Yapılacak: Korunmalı; son okumada yalnız alıntı/italik biçimi ve küçük noktalama kontrol edilmeli.
...
- Değişim: +1, yükseldi.
- Durum:
- Eski yorum: Özgürlük romantik değil, bedensel ve gündelik kuruluyordu.
- Güncel yorum: Bölüm sıkılaşmış; özgürlük artık gündelik, bedensel, politik ve kültürel katmanları birlikte taşıyor.
- Güçlü taraf: Özgürlük şiiri çağrışımı, Bozkırın Tezenesi, istiklal göndermesi, çaydanlık, kedi, toprak, salıncak ve dar ağacı karşıtlığı aynı duygu hattına bağlanıyor.
- Sorun: Belirgin sorun kalmadı; yalnız sert sokak köpeği imgesi ve uzun tanım dizisi son okumada ritim açısından kontrol ister.
- Yapılacak: Korunmalı; son okumada kültürel göndermeler ve özgürlük tanımı tekrar sanılıp sadeleştirilmemeli.
...
- Değişim: 0, aynı kaldı.
- Durum:
- Eski yorum: Haklar gövdesine çok iyi kapı açıyordu.
- Güncel yorum: Hakların unutulan şeyler olduğu fikri hâlâ çok net.
- Güçlü taraf: `İnsan ne istediyse, o da onu istedi` cümlesi bölümün kalbi.
- Sorun: Başlık biçimi dosya içinde teknik kaçış karakterleri taşıyor.
- Yapılacak: Yayın biçiminde başlık/numara formatı temizlenmeli.
...
- Değişim: 0, aynı kaldı.
- Durum:
- Eski yorum: Yırtıcı, kin, hırs ve insan eli karşıtlığı çok temiz çalışıyordu.
- Güncel yorum: Kısa, berrak ve manifesto sertliği dengeli.
- Güçlü taraf: Yırtıcının zalim olmayışı ile insan elinin boş kıyımı iyi karşıtlanıyor.
- Sorun: Belirgin mekanik sorun kalmadı; kutsal yemin tonu korunmalı.
- Yapılacak: Son okumada yalnız ritim ve vurgu kontrol edilmeli.

### 13 - Doğmamışın ve Yenidoğanın Hakkı

- Eski puan: 7/10
- Yeni puan: 9/10
- Değişim: +2, yükseldi.
- Durum:
- Eski yorum: Hassas karar hattı vardı ama daha berraklaşması gerekiyordu.
- Güncel yorum: Bölüm artık etik-hukuki sınırını daha açık kuruyor; doğacak canın hakkı ile ananın karar yetkisi aynı anda korunuyor.
- Güçlü taraf: Hassas konuyu yargılayıcı olmadan ana kararı, koruma ve kolektif sorumluluk eksenine çekiyor; kapanıştaki kut ve and bölümü şiirsel ağırlığı geri topluyor.
- Sorun: Belirgin sorun kalmadı; yalnız hukuki berraklık ile şiirsel ritim dengesi son okumada korunmalı.
- Yapılacak: Korunmalı; final okumada bu bölüm açıklama metnine çevrilmeden, mevcut etik-hukuki dengeyle bırakılmalı.

### 14 - Suyun, Toprağın ve Göğün Hakkı

- Eski puan: 6/10
- Yeni puan: 9/10
- Değişim: +3, yükseldi.
- Durum:
- Eski yorum: Temel fikir güçlüydü ama bölüm taslak/eksik hissediyordu.
- Güncel yorum: Yeni şehir gecesi, beyaz uğultu, ışık ve sinyal kalabalığı bölümü belirgin biçimde canlandırdı; okuma zevki arttı.
- Güçlü taraf: Su, toprak, gök, gece, sessizlik, karanlık ve görünmeyen kirlilik aynı hak duygusunda birleşiyor.
- Sorun: Belirgin sorun kalmadı; yalnız `Göğü kirleten dalgalar, gazlar` satırı son okumada teknikleşmeden korunmalı.
- Yapılacak: Korunmalı; final okumada başlık kapsamı ve görünmeyen kirlilik imgesi şiirsel ritim açısından son kez kontrol edilmeli.

### 15 - Yaban Yaşam Hakkı

- Eski puan: 8/10
- Yeni puan: 9/10
- Değişim: +1, yükseldi.
- Durum:
- Eski yorum: Av, esaret, lanet ve tüfeği duvara asma çağrısı güçlüydü.
- Güncel yorum: Bitki toplama ve açıklama hattı çıkınca bölüm daha odaklı aktı; av, esaret, deniz kıyımı ve yaban özgürlüğü aynı damar içinde birleşiyor.
- Güçlü taraf: Avı spor olmaktan çıkarıp boş heves ve güç gösterisi olarak teşhir ediyor; Anadolu parsı, son ördek/tavşan/keklik/balık ve ağdaki ilmek imgeleri kapanışı güçlendiriyor.
- Sorun: Belirgin sorun kalmadı; yalnız sert lanet ve avcıya doğrudan hitap tonu son okumada korunarak dengelenmeli.
- Yapılacak: Korunmalı; final okumada yaban yaşam odağına teknik açıklama veya yan hak başlığı yeniden eklenmemeli.

### 16 - Evcil Hayvanlarının Hakkı

- Eski puan: 8/10
- Yeni puan: 9/10
- Değişim: +1, yükseldi.
- Durum:
- Eski yorum: Borç, lokma, can alma ve af dileme hattı etkiliydi.
- Güncel yorum: Fazla didaktik tüketim ve kürk açıklamaları incelince bölüm daha odaklı aktı; vicdan borcu fikri artık metni tek başına taşıyor.
- Güçlü taraf: Sofradaki her lokmayı alınan canla ilişkilendirmesi, can almadan önce af dileme ve saçı geleneği bölüme güçlü bir tören/vicdan tonu veriyor.
- Sorun: Belirgin sorun kalmadı; yalnız doğrudan öldürme ve denek etme cümlelerinin sertliği final okumada ritim açısından korunarak dengelenmeli.
- Yapılacak: Korunmalı; final okumada et, kürk ve deney başlıkları yeniden maddeleşmeden aynı borç/af hattında bırakılmalı.
...
- Değişim: +1, yükseldi.
- Durum:
- Eski yorum: Kısa, canlı, eğlenceli ve netti.
- Güncel yorum: Bölüm kısa, canlı ve okuma zevki yüksek; böceğe duyulan tiksinmeyi mizah, ekoloji ve hak duygusuyla tersine çeviriyor.
- Güçlü taraf: Sivrisinek, bit, domates kökü, uğur böceği, kelebek ve bok böceği imgeleri gündelik refleksi yakalayıp hafif ama net bir etik sarsıntı kuruyor.
- Sorun: Belirgin sorun kalmadı; `rekreasyon alanı` kelimesi bilinçli şehir dili olarak korunursa çalışıyor.
- Yapılacak: Korunmalı; final okumada mizahi konuşma tonu törpülenmemeli.

### 18 - Su ve Suyun İçindekilerin Hakkı

- Eski puan: 8/10
- Yeni puan: 9/10
- Değişim: +1, yükseldi.
- Durum:
- Eski yorum: Deniz yaşamı, gürültü, petrol ve mikroplastik çizgisi netti.
- Güncel yorum: Yeni hâl rapor dilini azalttı; deniz canlıları, yeraltı suyu, petrol/gaz, sonar, nükleer deneme ve mikroplastik finali daha tek parça akıyor.
- Güçlü taraf: Balinaların aşk şarkıları, paslı kova/tulumba/pınar yemini ve mikroplastik dolu balıkların `müste-haktır` kapanışı akılda kalıyor.
- Sorun: Belirgin sorun kalmadı; yalnız boru, veri hattı, petrol ve gaz gibi teknik öğeler son okumada şiirsel bağlam içinde tutulmalı.
- Yapılacak: Korunmalı; final okumada teknik öğeler açıklama listesine dönüşmeden bu sert su ağıdı tonu korunmalı.

### 19 - Bitkinin, Tohumun Hakkı

- Eski puan: 8/10
- Yeni puan: 9/10
- Değişim: +1, yükseldi.
- Durum:
- Eski yorum: Tohumun ruhu, güneşe yürüyen bitki ve yerel tohum çağrısı iyi çalışıyordu.
- Güncel yorum: Bölüm kısa, temiz ve okuma zevki yüksek; tohumun ruhu, yerel tohum çağrısı ve sahip/patent dışı oluşu aynı hatta birleşiyor.
- Güçlü taraf: Elma çekirdeği, kesilen dalın budağı ve şeftali kabuğu imgeleri tohum hakkını somut ve dokunsal kılıyor.
- Sorun: Belirgin sorun kalmadı; `hakdır` kullanımı bilinçli kutsal/hüküm dili olarak korunmalı.
- Yapılacak: Korunmalı; final okumada tohumun patent dışı kutsal varlık oluşu açıklama listesine dönüştürülmemeli.

### 20 - Ormanlara Ayrıca Saygı

- Eski puan: 7/10
- Yeni puan: 9/10
- Değişim: +2, yükseldi.
- Durum:
- Eski yorum: Orman iyesi ve yaşlı ağaç cesedi güçlüydü ama uzunluk öncelikli sorundu.
- Güncel yorum: Teknik kirlilik ve açıklama blokları incelince bölüm daha törensel aktı; orman ruhu, yangın, Etügen ve insansızlık hakkı hattı belirginleşti.
- Güçlü taraf: Ormanı ürün değil üst akıl, ortak vatan ve yerle göğü bağlayan sütun olarak kurması çok güçlü; Etügen, orman iyesi ve Alaz göndermeleri bilinçli mitolojik katman olarak çalışıyor.
- Sorun: Belirgin sorun kalmadı; bölüm uzun ama bu uzunluk artık yasak listesinden çok orman yasası/tören dili gibi çalışıyor.
- Yapılacak: Korunmalı; final okumada Etügen, orman iyesi, Alaz ve insansızlık hakkı hattı açıklama diline çevrilmeden bırakılmalı.

### 21 - Doğal ve Kültürel Varlıklara Saygı

- Eski puan: 8/10
- Yeni puan: 9/10
- Değişim: +1, yükseldi.
- Durum:
- Eski yorum: Doğal varlık ile kültür mirası aynı saygı düzleminde tutuluyordu.
- Güncel yorum: Açıklama/restorasyon dili büyük ölçüde azaldı; kaybolan dil, destan, tanrı, türkü, fosil, iskelet ve duvar resmi hattı bölümü daha duygusal ve okunur yaptı.
- Güçlü taraf: Rüzgâr/su/zaman üçlüsü, unutulan diller ve arkeoloğun sabrı doğa ile tarih köprüsünü aynı yas duygusunda topluyor.
- Sorun: Belirgin sorun kalmadı.
- Yapılacak: Korunmalı; final okumada kültürel kayıp, fosil/iskelet/duvar resmi ve arkeolog sabrı hattı açıklama diline geri çevrilmemeli.

### 22 - Toprak ve Barınma Hakkı

- Eski puan: 8/10
- Yeni puan: 9/10
- Değişim: +1, yükseldi.
- Durum:
- Eski yorum: Yuva, karınca, eşik, misafirlik ve toprak emaneti iyi akıyordu.
- Güncel yorum: Yeni hâl daha canlı; yuva hakkı, inşaatın bozduğu canlılar, eşik adabı, misafirlik ve toprak emaneti aynı duygusal hatta birleşiyor.
- Güçlü taraf: Karınca tanıklığı, greyderin önündeki ağaçlar, kaçışan kuşlar, ikiye bölünen köstebekler, kapı/eşik geleneği ve minik kuş finali bölümü güçlendiriyor.
- Sorun: Belirgin sorun kalmadı; yalnız öğüt cümlelerinin ritmi final okumada korunmalı.
- Yapılacak: Korunmalı; final okumada yuva/misafirlik/toprak emaneti hattı kuru öğüt diline geri çevrilmemeli.

### 23 - Gıda ve Suya Erişim Hakkı

- Eski puan: 9/10
- Yeni puan: 9/10
- Değişim: 0, aynı kaldı.
- Durum:
- Eski yorum: Su kutsallığı, rızık ve paylaşım hattı çok iyi kurulmuştu.
- Güncel yorum: Su kutsallığı, işgal eleştirisi, gıda paylaşımı ve sıcak ekmek/taze soğan kapanışı birlikte güçlü akıyor.
- Güçlü taraf: Suya ticaret dışı kutsal varlık olarak bakması, insan işgalini gıda ve yuva hakkına bağlaması ve gündelik sofra tanıklığı çok etkili.
- Sorun: Belirgin sorun kalmadı.
- Yapılacak: Korunmalı; final okumada su/ticaret/gıda paylaşımı hattı açıklama diline geri çevrilmemeli.
...
- Değişim: +1, yükseldi.
- Durum:
- Eski yorum: Çöpü ölüm/dönüşüm döngüsüne bağlaması güçlüydü.
- Güncel yorum: ÇÖP döngüsü kitabın ana fikrini doğrudan taşıyor; ölüm, artık, kompost, çürüme ve yeniden doğuş hattı artık daha temiz akıyor.
- Güçlü taraf: Doğal dışkı/artık döngüsü ile insanın plastik, petrol, nükleer ve kimyasal mirası iyi karşıtlanıyor; sert kapanış görüntüleri çürüme estetiğini bilinçli biçimde güçlendiriyor.
- Sorun: Belirgin sorun kalmadı.
- Yapılacak: Korunmalı; final okumada sert kapanış imgeleri yumuşatılmadan, ÇÖP/yeniden doğuş hattı açıklama diline çevrilmeden bırakılmalı.

### 25 - Gezme, Dolaşma Hakkı

- Eski puan: 8/10
- Yeni puan: 9/10
- Değişim: +1, yükseldi.
- Durum:
- Eski yorum: Hareket, hapishane, hayvanat bahçesi ve yol metaforu güçlüydü.
- Güncel yorum: Yeni hâl belirgin biçimde sıkılaştı; hareket hakkı, kafes/hapishane karşılaştırması, yaban koridorları, eşik adabı ve yolculuk etiği artık daha dengeli akıyor.
- Güçlü taraf: Yolun yolcuya yuva olması, hayvanat bahçesi/hapishane karşılaştırması, yaban yollarının damar gibi akması ve pedal/rüzgâr kapanışı bölümü canlı ve akılda kalıcı yapıyor.
- Sorun: Belirgin sorun kalmadı; yalnız final okumada kozmik gezme hattının bölüm odağını dağıtmadığı son kez kontrol edilmeli.
- Yapılacak: Korunmalı; final okumada sıkılaşmış yol/hareket hattı tekrar eski uzun açıklama düzenine açılmamalı.

### 26 - Yavaşlık ve Yalnızlığa Saygı

- Eski puan: 8/10
- Yeni puan: 9/10
- Değişim: +1, yükseldi.
- Durum:
- Eski yorum: Şehir/yol/yavaşlık hattı canlı imgelerle rahatlamıştı.
- Güncel yorum: Yeni sardunya, çınar, kuş, kedi ve köpek dizisi yavaş şehir fikrini daha duyusal ve canlı kılıyor; hız, yol, yalnızlık ve hamak kapanışı dengeli akıyor.
- Güçlü taraf: Irmağın ovada ağırlaşması, hızlı yaşa/genç öl terslemesi, şehir canlıları, Arnavut kaldırımı ve hamak kapanışı bölümü canlı ve akılda kalıcı yapıyor.
- Sorun: Belirgin sorun kalmadı.
- Yapılacak: Korunmalı; final okumada sıkılaşmış yavaşlık/yalnızlık hattı yeniden uzun tüketim örnekleriyle açılmamalı.

### 27 - Uyku ve Dinlenme Hakkı

- Eski puan: 8/10
- Yeni puan: 9/10
- Değişim: +1, yükseldi.
- Durum:
- Eski yorum: Gece, ay, rüya, dinlenme ve ücretli kölelik hattı iyi çalışıyordu.
- Güncel yorum: Gece, ay, rüya, karanlık, şehir uğultusu, ücretli kölelik ve mezar kapanışı aynı dinlenme hakkı hattında birleşiyor.
- Güçlü taraf: Uyku hakkını karanlık, yıldız, rüya, çalışma düzeni, teknoloji ve ölümle bağlaması etkili.
- Sorun: Belirgin sorun kalmadı; yalnız çalışma/teknoloji bloğunun ağırlığı final okumada ritim açısından korunmalı.
- Yapılacak: Korunmalı; final okumada uyku ağıdı açıklama metnine dönüştürülmeden mevcut şiirsel/sert denge korunmalı.
...
Bu bölüm önceki todo dosyasındaki serbest notlardan korunmuştur. Ana değerlendirmeye işlenmemiş ham fikirler burada tutulur.
...
devletlerin,
şirketlerin,
insanın toprağı parsellemesi bitecek.

Toprak ve suların çok büyük bölümü
insan yerleşimine,
tarıma,
turizme,
madene **kapatılacak**;
...
yerin, toprağın,
hayatın kaynağı olan **“Etügen”** denecek.
...
### Haklar Sırası ve Bölüm Dizilimi

Organik Haklar gövdesi temizlendikten sonra, hakların kitap içindeki sırası ayrıca çalışılacak.

- Hangi hakkın hangi hakkın ardından gelmesi gerektiğini belirle.
- Benzer hakları yan yana mı, yoksa okuru yormamak için aralıklı mı yerleştirmek daha iyi olur, değerlendir.
- Merak/Öğrenme, Yavaşlık/Yalnızlık, Uyku/Dinlenme, Gezme/Dolaşma gibi akraba bölümlerin sırasını özellikle kontrol et.
- Açılıştaki `BU,...` şiir parçalarının kitap içindeki ritmini sırayla birlikte değerlendir.
- Yeni sıranın okurda merak, nefes ve yükseliş duygusu yaratıp yaratmadığını kontrol et.
